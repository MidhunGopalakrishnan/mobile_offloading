...
public class WorkerDeviceStats {
    ...
    public static WorkerDeviceStatistics getStats(Context context) {
        int batteryLevel = WorkerDeviceStats.getBatteryLevel(context);
        boolean charging = WorkerDeviceStats.isPluggedIn(context);
