...
public class WorkerDeviceAdapter extends RecyclerView.Adapter<WorkerDeviceAdapter.ViewHolder>{
    private Context context;
    private List<Worker> workers;

    public WorkerDeviceAdapter(@NonNull Context context, List<Worker> workers) {
    ...
    protected class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setWorkStatus(String workStatus) {
            if (workStatus.equals(GobalConstants.WorkStatus.WORKING)) {
                this.tvWorkStatus.setText("WORKING...");
            } else if (workStatus.equals(GobalConstants.WorkStatus.FINISHED)) {
                this.tvWorkStatus.setText("FINISHED");
            } else if (workStatus.equals(GobalConstants.WorkStatus.FAILED)) {
